...
If installing on Windows, please refer to [Installation on Windows](#installation-on-windows-experimental), for Ubuntu 12.04, please refer to [Installation on Ubuntu](#installation-on-ubuntu).
...
Ubuntu 12.04 version of Node/Npm will not work.  You can get use [Nvm](https://github.com/creationix/nvm) to install and manage a suitable Node version, or use the [Chris Lea Node PPA](https://launchpad.net/~chris-lea/+archive/node.js/).
